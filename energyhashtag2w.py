...
python_program = r'C:\working\weidong_scripts\energyhashtag1w.py'
the_other_python_script = r'C:\working\weidong_scripts\energyhashtag2w.py'
...
'#windfarm', '#WindTurbine', '#RenewableNaturalGas', '#wastetofuel', '#bioenergy', '#syngas', '#cellulosic',
'#gasoil', '#graphene', '#LPG', '#cleanenergy', '#Fracking', '#Gasification', '#syngas', '#THE',
'#envirofuel', '#wastetoenergy'],async=True,stall_warnings=True)
    except:
        ...
        # os.execv('/home/dxiong/socialmedia/energyhashtag1.py', sys.argv)
